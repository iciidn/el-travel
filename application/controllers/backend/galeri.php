...
class Galeri extends CI_Controller{
    ...
    function simpan_galeri(){
        $config['upload_path'] = './tampilan_web/web2/img/gallery/'; //path folder
        ...
        if(!empty($_FILES['filefoto']['name'])){
            if ($this->upload->do_upload('filefoto')){
                ...
                $config['source_image']='./tampilan_web/web2/img/gallery/'.$gbr['file_name'];
                $config['create_thumb']= FALSE;
               
                $config['new_image']= './tampilan_web/web2/img/gallery/'.$gbr['file_name'];
