...
class Album extends CI_Controller{
    ...
    function simpan_album(){
        $config['upload_path'] = './tampilan_web/images/'; //path folder
        ...
        if(!empty($_FILES['filefoto']['name'])){
            if ($this->upload->do_upload('filefoto')){
                ...
                $config['source_image']='./tampilan_web/images'.$gbr['file_name'];
                $config['create_thumb']= FALSE;
                
                $config['new_image']= './tampilan_web/images/'.$gbr['file_name'];
