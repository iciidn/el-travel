            ...
            <div class="box-body">
              <table id="example1" class="table table-striped" style="font-size:13px;">
                ...
                <tbody>
                    ...
                    ?>
                <tr>
                  <td><img class="img-thumbnail" width="90" height="80" src="<?php echo base_url().'tampilan_web/web2/img/gallery/'.$gambar; ?>"></td>
