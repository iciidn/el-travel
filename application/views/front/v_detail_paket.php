...
<head><meta http-equiv="Content-Type" content="text/html; charset=utf-8">
    ...
    <title>EL-Travel |Detail Paket</title>
                  ...
                  <div class="single-post">
                      ...
                      <div class="col-sm-4 text-center my-2 my-sm-0">
                        <ul class="social-icons">
                            <li><a href="http://www.facebook.com/sharer.php?u=http://deelabs.com/EL-travel/paket_tour" target="_blank"><i class="fab fa-facebook-f"></i></a></li>
                            <li><a href="https://twitter.com/share?url=http://deelabs.com/EL-travel/paket_tour&text=tour%20travel%20terjangkau&hashtags=TRAVEL" target="_blank"><i class="fab fa-twitter"></i></a></li>
                            <li><a href="whatsapp://send?text=http://deelabs.com/EL-travel/paket_tour" target="_blank" ><i class="fab fa-whatsapp"></i></a></li>
                      ...
                      <div class="blog_details">
                          <h2><?php echo $n['nama_paket'];?></h2>
                          <ul class="blog-info-link mt-3 mb-4">
                              <li><a href="#"><i class="far fa-user"></i>Dewasa &nbsp; us$. &nbsp; <?php echo $n['hrg_dewasa'];?>/PACK </a></li>
                             <li><a href="#"><i class="far fa-user"></i>Balita &nbsp; us$. &nbsp; <?php echo $n['hrg_anak'];?>/PACK </a></li>
