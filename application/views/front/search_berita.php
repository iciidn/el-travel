                ...
                <div class="col-lg-12">
                    <div class="breadcrumb_iner">
                        <div class="breadcrumb_iner_item text-center">
                            <h2>Blog Dokumentasi</h2>
                            <p>Cerita Traveling</p>
                        </div>
                    </div>
                </div>
            </div>
                      ...
                      <?php
                        ...
                        <article class="blog_item">
                            <div class="blog_item_img">
                                <a href="<?php echo base_url().'berita_post/detail_berita/'.$b->idberita;?>">
                                <img class="card-img rounded-0" src="<?php echo base_url().'assets/gambars/'.$b->gambar;?>" alt=""></a>

                                  <a href="<?php echo base_url().'berita_post/detail_berita/'.$b->idberita;?>" class="blog_item_date">
                                    <h3> Baca Isi Berita >></h3>

                                </a>
                            </div>

                            <div class="blog_details">
                                <a class="d-inline-block" href="<?php echo base_url().'berita_post/detail_berita/'.$b->idberita;?>">
                                    <h2><?php echo $b->judul?></h2>
                                </a>

                                <ul class="blog-info-link">
                                    <li><a href="#"><i class="far fa-calendar-alt"></i> &nbsp; <?php echo $b->tglpost?> by <?php echo $b->user;?></a></li>
                                    <li><a href="#"><i class="far fa-eye"></i> <?php echo $b->views;?> viewers</a></li>
                                </ul>
