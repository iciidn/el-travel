...
<head><meta http-equiv="Content-Type" content="text/html; charset=utf-8">
    ...
    <title>EL-Travel | Blog Detail</title>
                  ...
                  <div class="single-post">
                      ...
                      <div class="col-sm-4 text-center my-2 my-sm-0">
                        <ul class="social-icons">
                            ...
                            <li><a href="whatsapp://send?text=http://deelabs.com/EL-travel/berita_post/" target="_blank" ><i class="fab fa-whatsapp"></i></a></li>
                      ...
                      <div class="blog_details">
                          ...
                          <ul class="blog-info-link mt-3 mb-4">
                              ...
                              <li><a href="#"><i class="far fa-comments"></i> <?php echo $n['views'];?> Viewers</a></li>
                          </ul>
                          <p class="excert">
                              <?php echo $n['isi'];?>
                          </p>
