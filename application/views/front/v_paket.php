...
<body>
   ...
   <header class="main_menu">
    ...
    <!-- breadcrumb start-->
    <section class="breadcrumb breadcrumb_bt">
        <div class="container">
            <div class="row">
                <div class="col-lg-12">
                    <div class="breadcrumb_iner">
                        <div class="breadcrumb_iner_item text-center">
                            ...
                            <p>Dapatkan tawaran menarik dan juga diskon khusus untuk Anda</p>
                        </div>
                    </div>
                </div>
            </div>
                            ...
                            <article class="blog_item">
                                <div class="blog_item_img">
                                  <a href="<?php echo base_url().'paket_tour/detail_paket/'.$idberita;?>">
                                    ...
                                    <a href="<?php echo base_url().'paket_tour/detail_paket/'.$idberita;?>" class="blog_item_date">
                                        <h3>Lihat Detail >></h3>
                                ...
                                <div class="blog_details">
                                    <a class="d-inline-block" href="<?php echo base_url().'paket_tour/detail_paket/'.$idberita;?>">
                                        <h2><?php echo $judul;?></h2>
                                    </a>
                                    <p><?php echo $isi;?></p>
                                    <ul class="blog-info-link">
                                        <li><a href="#"><i class="far fa-user"></i>Dewasa &nbsp; us$. &nbsp; <?php echo $tglpost;?>/PACK </a></li>
                                        <li><a href="#"><i class="far fa-user"></i>Balita &nbsp; us$. &nbsp; <?php echo $anak;?>/PACK </a></li>
                                    </ul>
