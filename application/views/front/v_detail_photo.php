              ...
              <div class="row">
                   ...
                   <div class="col-md-12 card-columns">
                     <?php
                       ...
                       <div class="card">
                           <a href="<?php echo base_url().'tampilan_web/web2/img/gallery/'.$gbr_galeri;?>" class="gallery_img">
                              <img  src="<?php echo base_url().'tampilan_web/web2/img/gallery/'.$gbr_galeri;?>" title="<?php echo $jdl_galeri;?>" class="card-img-top" alt="">
                           </a>
                       </div>
    			...
    			<!-- Link back to Colorlib can't be removed. Template is licensed under CC BY 3.0. --><p>
    									<a href="<?php echo base_url().'welcome'?>" target="_blank">Chat Via WhatsApp</a>
    								</p>
    						</div>
    						</div>
    					</div>
